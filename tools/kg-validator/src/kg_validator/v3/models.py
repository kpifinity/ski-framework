...
These models are the source of truth for kg-validator's v3 schema
parsing. The reference implementation may import them directly when
PR 10 (runtime inversion) lands; until then the v3 runtime is not
wired up and these models are purely a validation aid.
"""
