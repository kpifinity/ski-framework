...
This first pass implements the subset that does not require sophisticated
unit handling:
...
already enforced at the Pydantic layer by
:mod:`kg_validator.v3.models`, so they surface as
:class:`pydantic.ValidationError` at :func:`load_v3_kg` time rather
than as runtime issues here.
"""
