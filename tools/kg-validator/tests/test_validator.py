...
class TestConflictDetection:
    ...
    def test_contradictory_limits(self):
        ...
        rule1 = ComplianceRule(
            id="1", subject="Facility discharge", relation="must_not_exceed",
            object="100 ppm sulfur dioxide",
            source_document="Clean Air Act", source_clause="Section 112",
            confidence="EXPLICIT", reasoning="Test",
        )
        rule2 = ComplianceRule(
            id="2", subject="Facility discharge", relation="must_not_exceed",
            object="50 ppm sulfur dioxide",
            source_document="State Regulation", source_clause="Chapter 3",
            confidence="EXPLICIT", reasoning="Test",
        )
    ...
    def test_contradictory_limits_with_decimals(self):
        ...
        rule1 = ComplianceRule(
            id="1", subject="Wastewater pH", relation="must_be_at_least",
            object="6.5", source_document="CWA", source_clause="Sec 304",
            confidence="EXPLICIT", reasoning="Test",
        )
        rule2 = ComplianceRule(
            id="2", subject="Wastewater pH", relation="must_be_at_least",
            object="6.0", source_document="State Reg", source_clause="Ch 7",
            confidence="EXPLICIT", reasoning="Test",
        )
        conflicts = ConflictDetector.detect_conflicts([rule1, rule2])
        assert len(conflicts) > 0
    ...
    def test_same_relation_same_value_no_conflict(self):
        ...
        rule1 = ComplianceRule(
            id="1", subject="Facility discharge", relation="must_not_exceed",
            object="100 ppm sulfur dioxide",
            source_document="Doc1", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
        rule2 = ComplianceRule(
            id="2", subject="Facility discharge", relation="must_not_exceed",
            object="100 ppm sulfur dioxide",
            source_document="Doc2", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
        conflicts = ConflictDetector.detect_conflicts([rule1, rule2])
        assert len(conflicts) == 0
    ...
    def test_no_conflict_different_subjects(self):
        ...
        rule1 = ComplianceRule(
            id="1", subject="Facility discharge", relation="must_not_exceed",
            object="100 ppm", source_document="Doc", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
        rule2 = ComplianceRule(
            id="2", subject="Equipment discharge", relation="must_not_exceed",
            object="100 ppm", source_document="Doc", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
        conflicts = ConflictDetector.detect_conflicts([rule1, rule2])
...
class TestDuplicateDetection:
    ...
    def test_no_duplicate_dissimilar(self):
        ...
        rule2 = ComplianceRule(
            id="2", subject="Equipment maintenance", relation="must_occur",
            object="quarterly", source_document="Doc", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
...
class TestValidation:
    ...
    def test_explicit_rules_auto_approve(self):
        ...
        rule = ComplianceRule(
            id="1", subject="Facility", relation="must", object="comply",
            source_document="Doc", source_clause="Clause",
            confidence="EXPLICIT", reasoning="Test",
        )
        validator = Validator()
    ...
    def test_discretionary_rules_are_flagged_for_review(self):
        rule = ComplianceRule(
            id="1", subject="Facility", relation="should", object="consider",
            source_document="Doc", source_clause="Clause",
            confidence="DISCRETIONARY", reasoning="Test",
        )
        validator = Validator()
        result = validator.validate([rule])
        assert len(result.approved_rules) == 0
