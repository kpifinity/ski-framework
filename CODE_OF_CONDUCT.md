...
We as members, contributors, and maintainers of the SKI Framework project
...
- Focusing on what is best not just for us as individuals, but for the
  overall community and the regulated-industry users who depend on the
...
- Submitting deliberately misleading conformance test results, vulnerability
  reports, or benchmark numbers — the framework targets regulated
  industries where integrity is non-negotiable, and intentional
  misrepresentation is treated as a Code of Conduct violation in addition
...
and pull requests, code review comments, the project's discussion forums,
the documentation site, conformance test submissions, and any future
mailing lists or chat channels — and also applies when an individual is
...
**conduct@kpifinity.com**. Reports include:

- A description of the incident.
- Links to the relevant content (issue, PR, comment) where possible.
- Whether you would like your identity kept confidential from the
  individual being reported (we default to yes).
